...
-> E-mail da CELESC: controle_manutencoes@algartelecom.com.br; spod_arblu@celesc.com.br; thiago.cavalari@algartelecom.com.br; uilson.souza@algartelecom.com.br; natanaelr@algartelecom.com.br; rnascimento@algartelecom.com.br; danielc@algartelecom.com.br; tamarat@algartelecom.com.br
...
SIEBEL:
http://siebel:7777/ecommunications_ptb/start.swe
...
show itnerface details | include <vlan>
show interface description | include <circuito>
...
show interfaces xe-2/2/1 | match flap   
show interface detail | match <vlan>
show interface description | match <circuito>
